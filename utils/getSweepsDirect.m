function swps = getSweepsDirect(stim, reverse)
% USAGE: swps = getSweepsDirect(stim, [reverse])
%
% INPUT: 
%   ds
...
try
    ...
    swps.interSweepFrames=centers(end);
    endSweeps_ind=find(Delta>=centers(end));
end
